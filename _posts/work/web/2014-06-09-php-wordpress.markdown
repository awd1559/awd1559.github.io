...
single.php
———————————————————
<?php comments_template(); ?>                 获取comments.php
...
www.wordpress.com
www.wordpress.org
www.wordpress.org/themes		主题
http://codex.wordpress.org		文档
http://codex.wordpress.org.cn	中文文档
www.wordpress.tv			视频(收费)

博客
http://levi.cg.am/			乱炖
http://www.ludou.org			露兜
http://www.wpdaxue.com/		wordpress大学
...
http://codex.wordpress.org/zh-cn:模板标签Theme
style.css 		指定相关的描述
Theme Name:
Theme URI:
Description: 
...
header
get_header():
如果没有header.php, 则使用wp-includes/theme-compat/header.php
...
模版标签
https://codex.wordpress.org/zh-cn:模板标签
...
get_footer()		
#footer.php
get_footer(‘home’)		#footer-home.php
...
条件标签
http://codex.wordpress.org/zh-cn:条件标签
is_home			
首页
is_front_page		
is_admin			
